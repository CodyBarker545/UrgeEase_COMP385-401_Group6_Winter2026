...
def load_and_prepare_data() -> tuple[pd.DataFrame, pd.Series]:
    ...
    # Create behavioral dependence score 
    dependence_features = [
        "Mindless_Use",
        "Distraction_When_Busy",
        "Restless_Without_SM",
    ...
    # references: https://link.springer.com/article/10.1007/s11469-026-01641-3, https://pmc.ncbi.nlm.nih.gov/articles/PMC3214398, https://journals.plos.org/plosone/article?id=10.1371%2Fjournal.pone.0320641, https://pmc.ncbi.nlm.nih.gov/articles/PMC11594359
    # higher weights for features more strongly associated with dependence based on literature review
    weights = {
        "Mindless_Use": 1.2,
...
def main() -> None:
    ...
    MODEL_PATH = MODEL_DIR / "social_media_users_rf.joblib"
